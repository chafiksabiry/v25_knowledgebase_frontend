...
ENV VITE_BACKEND_API=https://api-knowledge-base.harx.ai
...
ENV VITE_GIGS_API_URL=https://api-gigsmanual.harx.ai/api
ENV VITE_FRONT_URL=https://knowledge-base.harx.ai/
RUN npm run build
